...
-(void) connect {
    ...
    // [socket connectToHost:@"116.228.54.226" onPort:8083 withTimeout:10 error:&error];
...
//            NSString *content = @"";
//            
//            if (sqlite3_prepare_v2(db, [sqlQuery UTF8String], -1, &statementvalue:nil table:@"language"] == SQLITE_OK) {
